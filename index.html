      ...
      <div id="contactMe" class="container scrollspy">
        <div class="row">
          <div class="col l6 s12">
            ...
            <form id="contactForm" class="col s12" method="get" action="">
              <div class="row">
                <div class="input-field col s6">
                  <i class="material-icons prefix white-text">account_circle</i>
                  <input id="nameBox" type="text" class="white-text">
                ...
                <div class="input-field col s12">
                  ...
                  <textarea id="comments" class="materialize-textarea white-text"></textarea>
